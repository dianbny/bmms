...
?>
    <h3>Daily Checkup Tanggal : <?= $tgl."-".$bln."-".$thn; ?> | Kategori : <?= $namakategori['_kategori']; ?></h3>
                <div class="table-layout">
                    <?php
                        header("Content-type: application/vnd-ms-excel");
                        header("Content-Disposition: attachment; filename=Report Daily Checkup High Risk.xls");
                    ?>
                    <table>
                    <tr>
                        <th rowspan="2">No.</th>
                    ...
                    <?php
                        $no = 1;
                        foreach($getData->listPekerjaAllbyKategori($kategori) as $row){ ?>
                        <tr>
                            <td>'<?= $no++."."; ?></td>
