    ...
    if($getData->cekJumlahPekerja() > 0){ ?>
        ...
        <?php
          ...
          <?php }
                    ...
                    <a href="pages/_act_export_7.php?fungsi=<?= $_POST['function']; ?>&tanggal=<?= $day; ?>&bulan=<?= $bln; ?>&tahun=<?= $thn; ?>" class="linkTransferPg"><i class="fa fa-file-excel-o" aria-hidden="true"></i> &nbsp; Export</a>
         <?php  }
            }
            else { ?>
