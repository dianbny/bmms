...
<div class="container-form">
    <h5><i class="fa fa-plus-circle" aria-hidden="true"></i> &nbsp; Form Edit Data Isi Kotak P3K</h5><br>
    <form method="POST" action="simpan-update-isi-kotak-p3k-<?= $id; ?>" class="form-input">
        <fieldset>
        ...
        <fieldset>
            ...
            <input type="text" name="nama" id="nama" value="<?= $dataKotak['_nama_isi_kotak']; ?>" placeholder="Isi Nama Peralatan Medis/Obat" required><br>

            <label for="expired">Masa Expired &nbsp;<span style="color:red;font-size:15px;">*</span></label><br>
            <input type="date" name="expired" id="expired" value="<?= $dataKotak['_expired']; ?>" required><br>

            <label>Status Ketersediaan &nbsp;<span style="color:red;font-size:15px;">*</span></label><br>
            <select name="status" class="select" required>
                <option value="<?= $dataKotak['_status_tersedia']; ?>" selected><?= $dataKotak['_status_tersedia']; ?></option>
            ...
            <input type="number" name="jumlah" id="jumlah" value="<?= $dataKotak['_jumlah']; ?>" placeholder="Isi Jumlah" required><br>

            <label for="pemeriksaan_t">Pemeriksaan Terakhir &nbsp;<span style="color:red;font-size:15px;">*</span></label><br>
            <input type="date" name="pemeriksaan_t" id="pemeriksaan_t" value="<?= $dataKotak['_pemeriksaan_terakhir']; ?>" required><br>

            <label for="keterangan">Keterangan &nbsp;<span style="color:red;font-size:15px;">*</span></label><br>
            <input type="text" name="keterangan" id="keterangan" value="<?= $dataKotak['_keterangan']; ?>" placeholder="Isi Keterangan" required><br>

        </fieldset>

        <button type="button" class="btnForm" onclick="window.location.href = 'detail-data-kotak-<?= $dataKotak['_id_kotak']; ?>'">Kembali</button>
