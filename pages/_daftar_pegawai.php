...
<?php
    ...
    <form method="POST" action="daftar-pegawai" class="form-table">
                                ...
                                if($getData->cekPekerjabyFungsi($_POST['function'], "PEKERJA") > 0){
                                    foreach($getData->listPekerjabyFungsi($_POST['function'], "PEKERJA") as $row){ ?>
                                        <tr>
                                            ...
                                            <?php
                                                if($dataUserLogin['_level_user'] == "Admin"){ ?>
                                                    <td style="text-align:center;"><a href="edit-data-pekerja-<?= $row['_id_pekerja']; ?>" class="linkDetail"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                  ...
                  <?php }  ?> 
                            <tr>
                                ...
                                <td colspan="11" style="text-align:left;font-size:14px;">
                                    <?php
                                        for ($i=1; $i<=$pages ; $i++){ ?>
                                            <a href="daftar-pegawai-halaman-<?= $i; ?>" class="linkDetail"><?= " ".$i." "; ?></a>
                                  <?php }
                                        ?>
                                </td>
                            </tr>
...
<?php
    if($dataUserLogin['_level_user'] == "Admin"){ ?>
        <a href="tambah-data-pekerja" class="linkTransferPg"><i class="fa fa-plus-circle" aria-hidden="true"></i> &nbsp; Data Baru</a>
<?php }
?>
<a href="daftar-pegawai" class="linkTransferPg"><i class="fa fa-refresh" aria-hidden="true"></i> &nbsp; Refresh</a>
