...
<div class="container-form">
    <h5><i class="fa fa-plus-circle" aria-hidden="true"></i> &nbsp; Form Tambah Data TKJP/MK</h5><br>
    <form method="POST" action="simpan-pekerja" class="form-input">
        ...
        <input type="text" name="id" placeholder="Isi Nomor/ID" required><br>
        ...
        <input type="text" name="position" placeholder="Isi Jabatan TKJP/MK" required><br>

        <label for="status">Status &nbsp;<span style="color:red;font-size:15px;">*</span></label><br>
        <input type="text" name="status" value="TKJP/MK" readonly><br>

        <button type="button" class="btnForm" onclick="window.location.href = 'daftar-tkjp-mk'">Kembali</button>
